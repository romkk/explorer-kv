...
#ifndef FLATBUFFERS_GENERATED_EXPLORER_EFB_H_
#define FLATBUFFERS_GENERATED_EXPLORER_EFB_H_
...
struct Tx FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const TxInput *inputs() const { return GetPointer<const TxInput *>(16); }
  TxInput *mutable_inputs() { return GetPointer<TxInput *>(16); }
  ...
  const TxOutput *outputs() const { return GetPointer<const TxOutput *>(22); }
  TxOutput *mutable_outputs() { return GetPointer<TxOutput *>(22); }
...
struct TxBuilder {
  ...
  void add_inputs(flatbuffers::Offset<TxInput> inputs) { fbb_.AddOffset(16, inputs); }
  ...
  void add_outputs(flatbuffers::Offset<TxOutput> outputs) { fbb_.AddOffset(22, outputs); }
...
inline flatbuffers::Offset<Tx> CreateTx(flatbuffers::FlatBufferBuilder &_fbb,
   ...
   int32_t size = 0,
   int64_t fee = 0,
   flatbuffers::Offset<TxInput> inputs = 0,
   int32_t inputs_count = 0,
   int64_t inputs_value = 0,
   flatbuffers::Offset<TxOutput> outputs = 0,
...
struct AddressTx FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int64_t balance_diff() const { return GetField<int64_t>(6, 0); }
  bool mutate_balance_diff(int64_t balance_diff) { return SetField(6, balance_diff); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* tx_hash */) &&
           verifier.Verify(tx_hash()) &&
           VerifyField<int64_t>(verifier, 6 /* balance_diff */) &&
           verifier.EndTable();
  }
};
...
struct AddressTxBuilder {
  ...
  void add_balance_diff(int64_t balance_diff) { fbb_.AddElement<int64_t>(6, balance_diff, 0); }
  ...
  flatbuffers::Offset<AddressTx> Finish() {
    auto o = flatbuffers::Offset<AddressTx>(fbb_.EndTable(start_, 2));
    return o;
  }
};
...
#endif  // FLATBUFFERS_GENERATED_EXPLORER_EFB_H_
